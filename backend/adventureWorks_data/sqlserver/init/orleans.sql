IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = N'AdventureWorksOrleans')
BEGIN  
CREATE DATABASE [AdventureWorksOrleans]
END;
GO

USE [AdventureWorksOrleans]

/****** Object:  Table [dbo].[ContextVariables]    Script Date: 22/05/2024 10:35:13 ******/
SET ANSI_NULLS ON
